...
function setup(connection, programId) {
    ...
    var program = new anchor_1.Program(plege_1.IDL, programId !== null && programId !== void 0 ? programId : constants_1.SUBSCRIPTION_PROGRAM_ID, provider);
    _program = program;
}
exports.setup = setup;
function getProgram() {
    ...
    var program = new anchor_1.Program(plege_1.IDL, constants_1.SUBSCRIPTION_PROGRAM_ID, provider);
    _program = program;
    return program;
}
